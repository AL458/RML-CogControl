...
arg.rt_baseline=480;%minimal RT in ms
arg.rt_baseline_dualattr = 0; % minimal RT for dual attractor
arg.rt_baseline_DDM = 0;%480; % minimal RT for the DDM
arg.rt_timeout=630;%maximal RT in ms
