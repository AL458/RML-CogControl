function [dat,output,optimization_pars] = RML_main_opt_DDM_function(nsubj,Changed_optimum,W,We)
% Script for simulating the dACC activity at the location of choice
% (Changed_optimum), using the DDM-RML combined model. This function uses
% the number of subjects (nsubj), the prior value
% for the action and boost modules (W and We respectively) as input. It
...
% addpath(pwd)
% cd('Output')
% second_level_an_ho2_DDM_full(arg);
% cd('..')
