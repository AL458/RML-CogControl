function RML_main_opt_DDM(optimal_location,nsubj,savename)
...
optimization_pars.DDM.threshold_fix = 0;%optimization_pars.DDM.threshold_var; % Fixed part of threshold. If set to a non-zero value, this value is added to the boost-specific value indicated in the supplementary methods
...
optimization_pars.hlesion = optimal_location(5);
