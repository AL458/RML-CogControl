function second_level_an_ho2_dual_attractor_full(dat)
...
% the analyzed data at the end of the function.

addpath('../Scripts')
nstate=36;
% Check whether the data is provided and non empty, otherwise load the dat
% structure
try 
    dat = dat;
    fulldat =dat;
